...
if __name__ == '__main__':
    ...
    reward_manager_contract_address = web3.toChecksumAddress('0x8A80583BD5A5Cd8f68De585163259D61Ea8dc904')
    reward_manager_contract = web3.eth.contract(address=reward_manager_contract_address,
                                                        abi=reward_manager_abi)

    entity_address = web3.toChecksumAddress('0xBe311F1640b700F76D17C009a505487C23b0312c')
